                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="number" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                                                  ...
                                                  <input class="col-md-1"  type="radio" name="roles" value="3" checked> قاعة<br>
                                                  <input class="col-md-1" type="radio" name="roles" value= "4">شركة اكل<br>
                                                  <input class="col-md-1" type="radio" name="roles" value="5">شركة تنسيق<br>
